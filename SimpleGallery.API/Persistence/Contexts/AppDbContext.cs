...
namespace SimpleGallery.API.Persistence.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            OnAlbumsCreating(builder);
            OnPhotosCreating(builder);
            OnImagesCreating(builder);
        }

        #region ModelsCreating
        private void OnAlbumsCreating(ModelBuilder builder)
        {
        ...
        private void OnPhotosCreating(ModelBuilder builder)
        {
        ...
        private void OnImagesCreating(ModelBuilder builder)
        {
